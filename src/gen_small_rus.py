...
for _ in range(T):
    new_args = {
        ...
        'wanted-words': 'один,два,три,четыре,пять,да,нет,спасибо,стоп,включи'
    }
...
for i, cargs in enumerate(args):
    ...
    cmd.append('/home/kolesov93/study/datasets/rus_data')
    cmd.append('small_traindirs_rus/{:03d}_{}'.format(i, _make_traindir(cargs)))
